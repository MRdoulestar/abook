...
#
# Created: Wed Feb  8 15:20:16 2017
...
class Ui_addDialog(object):
    def setupUi(self, addDialog):
        ...
        self.changeButton = QtWidgets.QPushButton(addDialog)
        self.changeButton.setGeometry(QtCore.QRect(360, 60, 93, 28))
        ...
        self.changeButton.clicked.connect(addDialog.addTable)
        QtCore.QMetaObject.connectSlotsByName(addDialog)

    def retranslateUi(self, addDialog):
        _translate = QtCore.QCoreApplication.translate
        addDialog.setWindowTitle(_translate("addDialog", "修改联系人"))
        self.changeButton.setText(_translate("addDialog", "修改"))
